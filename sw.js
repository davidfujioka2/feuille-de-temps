const CACHE='chantier-2026-09-24-6';
const FILES=['./','./index.html','./feuille.html','./instructions.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
